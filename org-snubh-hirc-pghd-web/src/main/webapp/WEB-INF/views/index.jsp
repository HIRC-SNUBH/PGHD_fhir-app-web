...
<spring:eval expression="@customProperties['restservice']" var="REST_SERVICE_ROOT_URI"/>
<spring:eval expression="@customProperties['fhirservice']" var="FHIR_SERVICE_ROOT_URI"/>
